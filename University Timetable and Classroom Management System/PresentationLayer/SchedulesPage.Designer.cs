namespace University_Timetable_and_Classroom_Management_System
{
    public partial class SchedulesPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnGenerate = PageDesignerHelper.CreateButton("btnGenerate", "Generate", 648, 176, Color.FromArgb(15, 23, 42), Color.White);
            btnRefresh = PageDesignerHelper.CreateButton("btnRefresh", "Refresh", 768, 176, Color.White, Color.FromArgb(51, 65, 85));
            ...
            pnlEditor.Controls.Add(btnGenerate);
