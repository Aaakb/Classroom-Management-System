...
{
    public partial class FacultyMembersPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblPageTitle = PageDesignerHelper.CreateLabel("Faculty Members", 28, 22, 18F);
            lblPageSubtitle = PageDesignerHelper.CreateLabel("Manage teaching staff records used by schedules and assignments.", 30, 58, 10F, false);
            pnlEditor = CreatePanel(28, 94, 900, 210);
            lblEditorTitle = PageDesignerHelper.CreateLabel("Faculty Member Details", 24, 18, 13F);
            lblEditorSubtitle = PageDesignerHelper.CreateLabel("Create and maintain faculty member records.", 24, 45, 9F, false);
            lblFacultyMemberId = PageDesignerHelper.CreateLabel("Faculty ID", 24, 88);
            txtFacultyMemberId = PageDesignerHelper.CreateTextBox("txtFacultyMemberId", "Auto", 24, 113, true);
            lblFullName = PageDesignerHelper.CreateLabel("Full Name", 228, 88);
            txtFullName = PageDesignerHelper.CreateTextBox("txtFullName", "Enter full name", 228, 113);
            lblAcademicTitle = PageDesignerHelper.CreateLabel("Academic Title", 432, 88);
            cmbAcademicTitle = PageDesignerHelper.CreateComboBox("cmbAcademicTitle", 432, 113);
            ...
            lblTableTitle = PageDesignerHelper.CreateLabel("Faculty Members List", 24, 18, 13F);
            dgvRecords = PageDesignerHelper.CreateGrid("dgvRecords");
            colFacultyMemberId = PageDesignerHelper.CreateColumn("ID", 30F);
            colFullName = PageDesignerHelper.CreateColumn("Full Name", 130F);
            colAcademicTitle = PageDesignerHelper.CreateColumn("Academic Title", 90F);
            ...
            pnlEditor.Controls.Add(lblFacultyMemberId);
            pnlEditor.Controls.Add(txtFacultyMemberId);
            pnlEditor.Controls.Add(lblFullName);
            pnlEditor.Controls.Add(txtFullName);
            pnlEditor.Controls.Add(lblAcademicTitle);
            pnlEditor.Controls.Add(cmbAcademicTitle);
            ...
            dgvRecords.Columns.AddRange(new DataGridViewColumn[] { colFacultyMemberId, colFullName, colAcademicTitle });
        ...
        private Guna.UI2.WinForms.Guna2HtmlLabel lblFacultyMemberId;
        private Guna.UI2.WinForms.Guna2TextBox txtFacultyMemberId;
        private Guna.UI2.WinForms.Guna2HtmlLabel lblFullName;
        private Guna.UI2.WinForms.Guna2TextBox txtFullName;
        private Guna.UI2.WinForms.Guna2HtmlLabel lblAcademicTitle;
        ...
        private DataGridViewTextBoxColumn colFacultyMemberId;
        private DataGridViewTextBoxColumn colFullName;
        private DataGridViewTextBoxColumn colAcademicTitle;
    }
}
