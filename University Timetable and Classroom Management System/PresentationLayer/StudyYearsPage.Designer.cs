...
{
    public partial class StudyYearsPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblPageTitle = PageDesignerHelper.CreateLabel("Study Years", 28, 22, 18F);
            lblPageSubtitle = PageDesignerHelper.CreateLabel("Manage academic year records used across the timetable.", 30, 58, 10F, false);
            pnlEditor = CreatePanel(28, 94, 900, 210);
            lblEditorTitle = PageDesignerHelper.CreateLabel("Study Year Details", 24, 18, 13F);
            lblEditorSubtitle = PageDesignerHelper.CreateLabel("Create and maintain study year records.", 24, 45, 9F, false);
            lblStudyYearId = PageDesignerHelper.CreateLabel("Study Year ID", 24, 88);
            txtStudyYearId = PageDesignerHelper.CreateTextBox("txtStudyYearId", "Auto", 24, 113, true);
            lblYearName = PageDesignerHelper.CreateLabel("Year Name", 228, 88);
            txtYearName = PageDesignerHelper.CreateTextBox("txtYearName", "Enter year name", 228, 113);
            ...
            lblTableTitle = PageDesignerHelper.CreateLabel("Study Years List", 24, 18, 13F);
            dgvRecords = PageDesignerHelper.CreateGrid("dgvRecords");
            colStudyYearId = PageDesignerHelper.CreateColumn("ID", 30F);
            colYearName = PageDesignerHelper.CreateColumn("Year Name", 170F);
            ...
            pnlEditor.Controls.Add(lblStudyYearId);
            pnlEditor.Controls.Add(txtStudyYearId);
            pnlEditor.Controls.Add(lblYearName);
            pnlEditor.Controls.Add(txtYearName);
            ...
            dgvRecords.Columns.AddRange(new DataGridViewColumn[] { colStudyYearId, colYearName });
        ...
        private Guna.UI2.WinForms.Guna2HtmlLabel lblStudyYearId;
        private Guna.UI2.WinForms.Guna2TextBox txtStudyYearId;
        private Guna.UI2.WinForms.Guna2HtmlLabel lblYearName;
        ...
        private DataGridViewTextBoxColumn colStudyYearId;
